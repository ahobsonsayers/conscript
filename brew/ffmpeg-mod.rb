class FfmpegMod < Formula
  ...
  option "with-libplacebo-mod", "Enable GPU-accelerated image/video processing primitives"
  ...
  depends_on "libplacebo-mod" => :optional
  ...
  def install
    ...
    if build.with? "libplacebo-mod"
      ENV.prepend_path "PKG_CONFIG_PATH", Formula["libplacebo-mod"].opt_lib/"pkgconfig"
